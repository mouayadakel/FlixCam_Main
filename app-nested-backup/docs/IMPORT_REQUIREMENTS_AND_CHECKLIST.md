...
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| **Product name** | `Name`, `name`, `Product Name`, `Product`, `اسم`, `الاسم`, `Equipment Name`, `Equipment`, `Item`, `Item Name`, `Title`, `Product Title`, `model`, `Model` — or map your column to **الاسم (EN)** in the column mapper. |

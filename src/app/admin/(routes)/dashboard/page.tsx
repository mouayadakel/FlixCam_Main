...
const OverviewTab = dynamic(
  () => import('./overview/page').then((m) => ({ default: m.default })),
  { ssr: false, loading: () => <Skeleton className="h-64 w-full" /> }
)
const RevenueTab = dynamic(
  () => import('./revenue/page').then((m) => ({ default: m.default })),
  { ssr: false, loading: () => <Skeleton className="h-64 w-full" /> }
)
const RecentBookingsTab = dynamic(
  () => import('./recent-bookings/page').then((m) => ({ default: m.default })),
  { ssr: false, loading: () => <Skeleton className="h-64 w-full" /> }
)
const ActivityTab = dynamic(
  () => import('./activity/page').then((m) => ({ default: m.default })),
  { ssr: false, loading: () => <Skeleton className="h-64 w-full" /> }
)
const QuickActionsTab = dynamic(
  () => import('./quick-actions/page').then((m) => ({ default: m.default })),
  { ssr: false, loading: () => <Skeleton className="h-64 w-full" /> }
)

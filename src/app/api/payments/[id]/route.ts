  ...
  try {
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        gateway: payment.gateway || (payment.tapChargeId || payment.tapTransactionId ? 'tap' : null),
        externalId: payment.externalId || payment.tapChargeId || payment.tapTransactionId || null,

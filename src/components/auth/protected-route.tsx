...
export const ROUTE_PERMISSIONS: Record<string, string> = {
  ...
  '/admin/ops/cron': 'system.health_check',
  ...
  '/admin/clients/blacklist': 'client.blacklist',
  '/admin/settings/chatbot': 'settings.read',
  '/admin/support/conversations': 'settings.read',
  '/admin/reviews': 'client.read',
  '/admin/coupons': 'coupon.read',
  '/admin/marketing/shares': 'marketing.read',
  '/admin/marketing/analytics': 'marketing.read',
  '/admin/marketing/campaigns': 'marketing.read',
  '/admin/marketing/pixels': 'marketing.read',
  '/admin/marketing/social': 'marketing.read',
  '/admin/marketing/email': 'marketing.read',
  '/admin/marketing/seo': 'marketing.read',

...
| Item | Status | Notes |
|------|--------|------|
| Unit: booking validators (requestChange, requestExtension, cancel) | ☐ | validators/__tests__/booking.validator.test.ts |
| Unit: late-fee.utils | ☐ | utils/__tests__/late-fee.utils.test.ts |
| Unit: whatsapp-context | ☐ | utils/__tests__/whatsapp-context.test.ts |
| Integration: portal booking API payload validation | ☐ | api/__tests__/portal-bookings.test.ts |
